...
namespace Green.Services.Authentication
{
    ...
    /// </summary>
    public static class GreenCookieAuthenticationDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly string CookiePrefix = ".Green.";

        /// <summary>
        /// The issuer that should be used for any claims that are created
        /// </summary>
        public static readonly string ClaimsIssuer = "greenSocial";
